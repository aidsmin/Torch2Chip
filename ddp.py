...
import torchvision
from t2c import T2C
from utils import dali_loader, str2bool, load_ddp_checkpoint
from trainer import BaseTrainer, SparseTrainer, DisTrainer
...
parser.add_argument('--train_dir', type=str, default='./data/', help='data directory of training set')
parser.add_argument('--val_dir', type=str, default='./data/', help='data directory of validation set')
...
def main():
    ...
    # dataloaders
    trainloader, testloader, num_classes, img_size = dali_loader(args)
